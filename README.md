...
- **Modular programming** with separate header/source files
- **Data structure** design and management
- **Input validation** and error handling
- **System workflow** design
- **Backward compatibility** in data formats
...
- GUI implementation (GTK+, Win32, or Qt)
...
- Maximum 100 slots supported (configurable via `MAX_SLOTS` in `data.h`)
- All monetary values in Taka (TK)
- Time-based operations use 24-hour format
- Data files are created automatically on first run
- System maintains backward compatibility with older data formats

---

## 👥 Development

This project was developed as a collaborative effort focusing on:
- **Slot & Owner Management** (Member-2)
- **Booking & User Management** (Member-3)
